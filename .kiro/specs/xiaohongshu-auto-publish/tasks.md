...
- [ ] 20. 实现窗口-表格一对一映射发布功能
  ...
  - 重构多账号发布组件，支持按窗口分组显示笔记
  - 实现从每个窗口对应的飞书表格加载笔记
  - 实现每个窗口独立显示发布进度和状态
  - 实现多窗口并行发布，每个窗口发布自己的笔记

  - _需求：12.1, 12.2, 12.3, 12.4, 12.5_



- [x] 20.1 更新 MultiAccountPublish 组件

  - 移除手动选择窗口的功能
  - 添加"加载笔记"按钮，根据映射从各表格加载
  - 按窗口分组显示笔记列表
  - 每个窗口显示独立的发布进度
...
- [ ]* 20.3 编写属性测试：窗口表格映射一致性
  - **Feature: xiaohongshu-auto-publish, Property 18: 窗口表格映射一致性**
  - **验证需求：12.1**

- [ ]* 20.4 编写属性测试：按窗口分组加载笔记
  - **Feature: xiaohongshu-auto-publish, Property 19: 按窗口分组加载笔记**
  - **验证需求：12.2, 12.3**

- [ ]* 20.5 编写属性测试：窗口并行发布隔离
  - **Feature: xiaohongshu-auto-publish, Property 20: 窗口并行发布隔离**
  - **验证需求：12.4**
